...
class LaporanPenjualanTolakController extends Controller
{
    //
    public function index()
    {
        return view('admin.laporan.penjualantolak.page');
    }
    ...
    public function search(Request $r)
    {
        ...
        return DataTables::of($penjualan)
            ...
            ->addColumn('detail', function ($pembayaran) {
                return '<a class="btn-sm btn-success" id="btn-detail" href="/admin/laporan/penjualantolak/detail?noTrans=' . $pembayaran->noTrans . '" target="_blank">Lihat Detail</a>';
            })
    ...
    public function print(Request $r)
    {
        ...
        $pdf = PDF::loadview('admin.laporan.penjualantolak.report', ['penjualan' => $penjualan, 'periode' => $periode, 'total' => $total]);
    ...
    public function detail(Request $r)
    {
        $trans = KeranjangModel::query()
            ...
            ->select(
                ...
                'tb_pembayaran.alasan as alasan'
            )
        ...
        return view('admin.laporan.penjualantolak.detail')->with(['transaksi' => $trans, 'subtotal' => $subtotal, 'ongkir' => $ongkir, 'total' => $total, 'status' => $status]);
    }
    ...
    public function invoice(Request $r)
    {
        ...
        $pdf = PDF::loadView('admin.laporan.penjualantolak.nota', ['transaksi' => $trans, 'subtotal' => $subtotal, 'ongkir' => $ongkir, 'total' => $total, 'status' => $status]);
