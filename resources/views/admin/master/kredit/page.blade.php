        ...
        <div class="col-md-12">
            <div class="text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Data Pengajuan Kredit</li>
                    </ol>
            </div>
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <div class="table-responsive-lg">
                        <table id="tb-kredit" class="table table-striped  table-bordered table-hover display nowrap" cellspacing="0" width="100%" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nama Pemohon</th>
...
$(document).ready(function () {
    ...
    table = $('#tb-kredit').DataTable({
        ...
        columnDefs: [
            ...
            { targets: [7], width:'25%'},
            { targets: [8], width:'25%'},
            { targets: [9], width:'10%', orderable: false},
            {
