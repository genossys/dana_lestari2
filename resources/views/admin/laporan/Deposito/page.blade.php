            ...
            <div class="col-md-12">
                <div class="text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Laporan Pengajuan Deposito</li>
                    </ol>
                </div>
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">Laporan Pengajuan Deposito</div>
                            </div>
                        </div>
                        <hr>
                        <div class="filter-table">
                            <form method="get" action="/admin/laporandeposito/print" target="_blank">
                                @csrf
                            <div class="row">
                                <div class="col-md-3">
...
$(document).ready(function () {
    ...
    table = $('#example2').DataTable({
        ...
        ajax: {
            type : 'GET',
            url : '/admin/laporandeposito/view',
            'data' : function(d){
                return $.extend(
                    {},
                    d,
