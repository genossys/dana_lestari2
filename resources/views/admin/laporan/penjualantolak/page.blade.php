            ...
            <div class="col-md-12">
                <div class="text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Laporan Penjualan Di Tolak</li>
                    </ol>
                </div>
                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">Laporan Penjualan Di Tolak</div>
                            </div>
                        </div>
                        <hr>
...
$(document).ready(function () {
    ...
    table = $('#tb-penjualan').DataTable({
        ...
        ajax: {
            type : 'GET',
            url : '/admin/laporan/penjualantolak/view',
            'data' : function(d){
                return $.extend(
                    {},
                    d,
