                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">: {{$transaksi[0]->alasan}}</div>
                            </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                                <a href="/admin/laporan/penjualantolak/invoice?noTrans={{$transaksi[0]->noTrans}}" target="_blank" id="btnCetak" class="btn btn-primary" style="display: inline-block"><i id="iconbtn" class="fa  fa-print" aria-hidden="true"></i>&nbsp;Cetak Invoice</a>
                        </div>
                    </div>
                </div>
